  ...
  return (
    <section className="bg min-h-[600px] p-12 flex items-center justify-evenly max-md:flex-col max-md:justify-center">
      <div className="max-md:order-2 mb-4 md:mb-0 max-md:text-center space-y-4 md:mt-16 mt-0 md:ml-32 ml-0">
        ...
        <button
          className="button md:w-[205px] md:h-[50px] md:ml-[4px] ml-0 md:mt-[11px] mt-3 text-white text-lg 
      ...
      <div
        className="md:order-1 mb-10 w-full flex justify-center md:mt-[120px] mt-0 md:ml-[150px] ml-0
            drop-shadow-2xl "
      >
        <Image
